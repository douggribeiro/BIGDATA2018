...
-- verifica numero e atual de acordo, adicionando cada elemento gerado na lista [n]
collatz :: Int -> [Int]
collatz 1 = [1]
...
-- Foldl recebe o valor do pmax e verifica um a um com o vetor xs, no caso, 1 a 1M.
